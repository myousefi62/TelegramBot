...
--
-- Host: localhost:3306
-- Generation Time: Jul 16, 2018 at 05:37 PM
...
CREATE TABLE `commands` (
  `id` int(11) NOT NULL,
  `text_fa` varchar(100) CHARACTER SET utf8 COLLATE utf8_persian_ci NOT NULL,
  `text_en` varchar(100) CHARACTER SET utf8 COLLATE utf8_persian_ci NOT NULL,
  `orderCommand` int(11) NOT NULL,
...
INSERT INTO `commands` (`id`, `text_fa`, `text_en`, `orderCommand`, `description`) VALUES
(1, 'کمک', 'help', 2, 'راهنمایی دستورات'),
(2, 'لغو ❎', 'cancel', 0, 'لغو گفتگو یا فرم درحال اماده سازی'),
(3, 'ثبت نام کاربر', 'reginbot', 0, ''),
(4, 'ثبت نمونه', 'survey', 0, ''),
(5, 'ثبت', 'reg', 0, ''),
(6, 'کیبرد داخلی', 'inlinekeyboard', 0, 'کیبرد داخلی'),
(7, 'حذف کیبرد', 'hidekeyboard', 0, 'پاک سازی کیبرد'),
(8, 'کیبرد', 'keyboard', 0, 'لیست دستورات مجاز کاربر'),
(9, 'مشخصات کاربر', 'whoami', 0, 'اطلاعات کاربر ثبتی در تلگرام و ربات');
...
--
-- Table structure for table `userـdetail`
--

CREATE TABLE `userـdetail` (
  `user_id` int(11) NOT NULL,
...
--
-- Indexes for table `user_commands`
--
ALTER TABLE `user_commands`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `userـdetail`
--
ALTER TABLE `userـdetail`
...
--
ALTER TABLE `conversation`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Unique identifier for this entry', AUTO_INCREMENT=28;
--
...
--
ALTER TABLE `request_limiter`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Unique identifier for this entry', AUTO_INCREMENT=1523;
--
-- AUTO_INCREMENT for table `user_commands`
--
ALTER TABLE `user_commands`
